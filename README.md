...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gffes4y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gffes4y.containers.anotherwebservice.com/
...
```
git clone git@github.com:kwekewk/container-gffes4y.git
cd container-gffes4y
```
...
```
docker attach container-gffes4y
```
